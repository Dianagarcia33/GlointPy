...
async def get_all_investments(
    ...
    for inv in investors:
        ...
        response_list.append({
            ...
            "tusdatos_job_id": getattr(inv, 'tusdatos_job_id', None),
            "tusdatos_status": getattr(inv, 'tusdatos_status', None),
            "tusdatos_report_id": getattr(inv, 'tusdatos_report_id', None),
            "tusdatos_hallazgos": getattr(inv, 'tusdatos_hallazgos', None),
            "tusdatos_msg": getattr(inv, 'tusdatos_msg', None),
            "tusdatos_sources": getattr(inv, 'tusdatos_sources', None),
            "tusdatos_justificacion": getattr(inv, 'tusdatos_justificacion', None),
            "tusdatos_evidencia_paths": getattr(inv, 'tusdatos_evidencia_paths', None),
            "tusdatos_hallazgos_corregidos": getattr(inv, 'tusdatos_hallazgos_corregidos', None),
            "tusdatos_fecha_correccion": getattr(inv, 'tusdatos_fecha_correccion', None),
            "tusdatos_corregido_por": getattr(inv, 'tusdatos_corregido_por', None),
            "tusdatos_last_check": getattr(inv, 'tusdatos_last_check', None),
            ...
            "representante_legal_nombre": getattr(inv, 'representante_legal_nombre', None),
            "representante_legal_documento": getattr(inv, 'representante_legal_documento', None),
            "representante_legal_email": getattr(inv, 'representante_legal_email', None),
            "representante_legal_telefono": getattr(inv, 'representante_legal_telefono', None),
