        ...
        <aside className="w-64 flex flex-col h-full overflow-y-auto z-10 transition-all duration-300 scrollbar-thin scrollbar-thumb-slate-200 hover:scrollbar-thumb-brand-300">
            <div className="flex flex-col py-6 px-4 gap-1">
                ...
                <button 
                    ...
                    className="w-full flex items-center justify-between px-3 mt-1 mb-1 text-[10px] font-bold text-slate-400 hover:text-slate-600 uppercase tracking-[0.2em] transition-colors cursor-pointer select-none"
                >
                    <span>PRINCIPAL</span>
                    <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-200 ${openSections.principal ? '' : '-rotate-90'}`} />
                </button>
                ...
                <button 
                    ...
                    className="w-full flex items-center justify-between px-3 mt-5 mb-1 text-[10px] font-bold text-slate-400 hover:text-slate-600 uppercase tracking-[0.2em] transition-colors cursor-pointer select-none"
                >
                    <span>FINANZAS Y CUENTA</span>
                    <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-200 ${openSections.finanzas ? '' : '-rotate-90'}`} />
                </button>
                    ...
                    <div className="flex flex-col gap-1 transition-all">
                        <Can permission="wallets:view">
                            <NavLink to="/dashboard/wallet" className={navLinkClass}>
                                ...
                                <span className="flex-1 text-[13px]">Mi Billetera</span>
                            </NavLink>
                        </Can>
                            ...
                            <>
                                ...
                                <Can permission="referrals:view">
                                    <NavLink to="/dashboard/referrals" className={navLinkClass}>
                                        ...
                                        <span className="flex-1 text-[13px]">Mis Referidos</span>
                                    </NavLink>
                                </Can>
                            </>
                        )}
                ...
                <Can permission="commercial:view">
                    <button 
                        ...
                        className="w-full flex items-center justify-between px-3 mt-5 mb-1 text-[10px] font-bold text-slate-400 hover:text-slate-600 uppercase tracking-[0.2em] transition-colors cursor-pointer select-none"
                    >
                        <span>GESTIÓN COMERCIAL & CRM</span>
                        <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-200 ${openSections.comercial ? '' : '-rotate-90'}`} />
                    </button>
                ...
                <Can permissions={[
                    ...
                    >
                        ...
                        <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-200 ${openSections.admin ? '' : '-rotate-90'}`} />
                    </button>
