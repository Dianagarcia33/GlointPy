...
import { CheckCircle2, Loader2, User, FileText, Mail, LockKeyhole, Eye, EyeOff, Landmark, CreditCard, Calculator, MapPin, Phone } from 'lucide-react';
...
export const InvestorRegistrationFlow = () => {
    ...
    const handleFinalSubmit = (e: React.FormEvent) => {
        ...
        const payload = {
            ...
            kyc_docs: [], // No kyc docs (OCR disabled)
