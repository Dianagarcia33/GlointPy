...
export const BulkUploadModal: React.FC<BulkUploadModalProps> = ({ isOpen, onClose, onUploaded }) => {
  ...
  const handleDownloadTemplate = () => {
    ...
    const example = ["", "Admin Principal", "admin@gloint.com.co", "123456789", "+573001234567", "1990-01-01", "Admin, Supervisor"];
    const example2 = ["99", "Cajero 1", "cajero@gloint.com.co", "987654321", "+573009876543", "1995-05-15", "Cajero"];
