...
import { bulkUploadInvestmentRequests } from '../../../../services/investment_requests';

interface BulkUploadInvestmentRequestsModalProps {
  isOpen: boolean;
  onClose: () => void;
  onUploaded: () => void;
}

export const BulkUploadInvestmentRequestsModal: React.FC<BulkUploadInvestmentRequestsModalProps> = ({
  isOpen,
  onClose,
  onUploaded
}) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (lines.length <= 1) {
        throw new Error("El archivo está vacío o no tiene solicitudes.");
      }
      
      const header = lines[0];
      const dataLines = lines.slice(1);
      const chunkSize = 50; // Increased chunk size for faster processing of large files
      ...
      for (let i = 0; i < dataLines.length; i += chunkSize) {
        ...
        const response = await bulkUploadInvestmentRequests(chunkFile);
  ...
  const downloadTemplate = () => {
    ...
    link.setAttribute("download", "plantilla_solicitudes_inversion.csv");
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden flex flex-col">
        <div className="flex items-center justify-between p-6 border-b border-slate-100">
          <h3 className="text-lg font-semibold text-slate-800 flex items-center gap-2">
            ...
            Carga Masiva de Solicitudes de Inversión
          </h3>
          <button
            onClick={() => {
              setFile(null);
            ...
            <div className="mb-6 bg-blue-50 border border-blue-100 rounded-lg p-4 flex gap-3">
              ...
              <div className="text-sm text-blue-800 w-full">
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-1 pl-4 mb-3 text-xs">
                  ...
                  <li><strong>investor_id:</strong> (Opcional)</li>
                  <li><strong>prospecto_id:</strong> (Opcional)</li>
                  <li><strong>comprobante_path:</strong> (Opcional)</li>
                  <li><strong>rejection_reason:</strong> (Opcional)</li>
                  <li><strong>reviewed_by:</strong> (Opcional)</li>
                  <li><strong>extra_data:</strong> JSON (Opcional)</li>
                  <li><strong>reviewed_at:</strong> YYYY-MM-DD HH:MM:SS</li>
                  <li><strong>created_at:</strong> YYYY-MM-DD HH:MM:SS</li>
                  <li><strong>updated_at:</strong> YYYY-MM-DD HH:MM:SS</li>
                  <li><strong>deleted_at:</strong> YYYY-MM-DD HH:MM:SS</li>
                </div>
                <button 
            ...
            <div className="space-y-4">
              {result.success > 0 && (
                <div className="p-4 bg-emerald-50 border border-emerald-100 rounded-xl flex gap-3 items-center text-emerald-700">
                  ...
                  <div>
                    <p className="font-semibold">¡Carga completada parcialmente/totalmente!</p>
                    <p className="text-sm">{result.success} solicitudes creadas correctamente.</p>
                  </div>
                </div>
              )}
