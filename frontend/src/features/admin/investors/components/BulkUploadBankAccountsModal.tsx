...
import { bulkUploadBankAccounts } from '../../../../services/bank_accounts';

interface BulkUploadBankAccountsModalProps {
  isOpen: boolean;
  onClose: () => void;
  onUploaded: () => void;
}

export const BulkUploadBankAccountsModal: React.FC<BulkUploadBankAccountsModalProps> = ({
  isOpen,
  onClose,
  onUploaded
}) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (lines.length <= 1) {
        throw new Error("El archivo está vacío o no contiene cuentas.");
      }
      ...
      for (let i = 0; i < dataLines.length; i += chunkSize) {
        ...
        const response = await bulkUploadBankAccounts(chunkFile);
  ...
  const downloadTemplate = () => {
    const csvContent = "\uFEFFusuario_id;banco;tipo_cuenta;numero_cuenta\n1;Bancolombia;Ahorros;123456789\n2;Nequi;Ahorros;3124567890";
    const blob = new Blob([csvContent], { type: 'text/csv;charset=utf-8;' });
    const url = URL.createObjectURL(blob);
    const link = document.createElement("a");
    link.setAttribute("href", url);
    link.setAttribute("download", "plantilla_cuentas_bancarias.csv");
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden flex flex-col">
        <div className="flex items-center justify-between p-6 border-b border-slate-100">
          <h3 className="text-lg font-semibold text-slate-800 flex items-center gap-2">
            ...
            Carga Masiva de Cuentas Bancarias
          </h3>
          <button
            onClick={() => {
              setFile(null);
            ...
            <div className="mb-6 bg-blue-50 border border-blue-100 rounded-lg p-4 flex gap-3">
              ...
              <div className="text-sm text-blue-800">
                ...
                <ul className="list-disc pl-4 space-y-1 text-blue-700/80 mb-3">
                  ...
                  <li><strong>banco:</strong> Nombre de la entidad (ej: Bancolombia, Nequi, etc).</li>
                  <li><strong>tipo_cuenta:</strong> Ahorros, Corriente, o Billetera Digital.</li>
                  <li><strong>numero_cuenta:</strong> Número de la cuenta bancaria.</li>
                </ul>
                <button 
              ...
              {result.success > 0 && (
                <div className="p-4 bg-emerald-50 border border-emerald-100 rounded-xl flex gap-3 items-center text-emerald-700">
                  ...
                  <div>
                    ...
                    <p className="text-sm">{result.success} cuentas bancarias cargadas correctamente.</p>
                  </div>
                </div>
              )}
