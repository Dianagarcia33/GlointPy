...
interface BulkUploadPackagesModalProps {
  isOpen: boolean;
  onClose: () => void;
  onUploaded: () => void;
}

export const BulkUploadPackagesModal: React.FC<BulkUploadPackagesModalProps> = ({ isOpen, onClose, onUploaded }) => {
  ...
  const handleDownloadTemplate = () => {
    ...
    const headers = ["valor", "acciones_otorgadas", "activo"];
    const example = ["1000", "5", "true"];
    const example2 = ["5000", "25", "true"];
    ...
    link.setAttribute("download", "plantilla_paquetes.csv");
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (lines.length <= 1) {
        throw new Error("El archivo está vacío o no tiene paquetes.");
      }
      ...
      for (let i = 0; i < dataLines.length; i += chunkSize) {
        ...
        const uploadResult = await packagesService.uploadBulkPackages(chunkFile);
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 flex gap-3">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <ul className="list-disc pl-4 space-y-1">
                    ...
                    <li><strong>valor</strong>: El precio o valor del paquete (ej. 1000).</li>
                    <li><strong>acciones_otorgadas</strong>: La cantidad de acciones (ej. 5).</li>
                    <li><strong>activo</strong>: Escribe <em>true</em> para activo, <em>false</em> para inactivo.</li>
                  </ul>
                  <button 
            ...
            <div className="space-y-4">
              <div className="p-6 bg-slate-50 rounded-xl border border-slate-200 text-center">
                ...
                <p className="text-slate-600">
                  Se crearon <strong className="text-emerald-600">{result.success}</strong> paquetes exitosamente.
                </p>
              </div>
